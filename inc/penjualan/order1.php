...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-6">
                          ...
                          <?php
                            ...
                            while($row=mysql_fetch_array($sql))
                            {
                              ...
                              $nama=str_replace("'"," ", $nama);
                               ...
                               $customer=mysql_query("SELECT * FROM orderan LEFT JOIN customer ON orderan.id_customer = customer.id_customer where invoice='$tambah' ");
            ...
            <form method="POST" action="inc/penjualan/order_penjualan1.php">  
            <?php 
            include "config/koneksi.php";
            $tambah=$_REQUEST['tambah'];
            $s=mysql_query("SELECT * FROM orderan LEFT JOIN customer ON orderan.id_customer = customer.id_customer where invoice='$tambah' ");
            $u=mysql_fetch_array($s); 
            ?>       
             <div class="form-group">
                    <label>Nama Customer</label>
                    <input type="hidden" name="invoice1" value="<?php echo $u['invoice']; ?>">
       ...
       width="800px">
        ...
        <tbody>
         <?php
            ...
            AND pe.invoice = o.invoice and o.invoice='$tambah'");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="inc/penjualan/order_proses1.php">
          <input type="hidden" name="tgl_jual" id="tgl_jual" />
          
          <table id="pembayaran1">
               <tr>
                  <td>Total Belanja</td>
                  <td>:</td>
                  <td>
                    <input type="hidden" name="id_cus" value="<?php echo $u['id_customer']; ?>">
                    <input type="hidden" name="invo" value="<?php echo $u['invoice']; ?>">
                    <input type="text" id="totalb" name="totalb" class="form-control form1 rupoh rupiahformat1" value="<?php echo $total_bayar; ?>"/>
                  </td>
              </tr>
              <tr>
                  <td>Ongkir</td>
                  <td>:</td>
                  <td>
                    <input type="text" id="ongkir" name="ongkir" onkeyup="ongkir1()" class="form-control form1 rupoh rupiahformat1" autocomplete="off" />
                  </td>
              </tr>
               <tr>
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" id="total12" name="total12" class="form-control form1 rupoh rupiahformat1"/>
                  </td>
              </tr>
              <tr>
                  <td>Bayar</td>
                  <td>:</td>
                  <td>
                    <input type="text" id="bayar" data-bayar="bayar" name="bayar" class="form-control form1 rupoh rupiahformat1" onkeyup="kembali()" autocomplete="off"/>
                  </td>
              </tr>
              <tr>
                  <td>Sisa</td>
                  <td>:</td>
                  <td>
                    <input id="kembalian" data-kembalian="kembalian" type="text" name="kembalian" class="form-control form1 rupoh rupiahformat1" />
                  </td>
              </tr>
              <tr>
                  <td>Catatan</td>
